...
namespace AuthorizationServer.Controllers.Account
{
    /// <summary>
    ...
    {
        private readonly TestUserStore _users = new TestUserStore(new List<TestUser>());
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            {
                if (await _userRepository.AreUserCredentialsValid(model.Username, model.Password))
                {
